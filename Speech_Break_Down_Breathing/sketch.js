...
let initialSound;
let speechOutput;
const disciplineWord = ["what did you say", "i cannot hear you", "why you trying to speak something","be quiet okay","shut up"];
let song;
let cursorImg;
let infoImg;
...
function preload() {
  initialSound = loadTable('./assets/initialSound.csv', 'csv', 'header');
  song = createAudio('./assets/lullaby.mp3');
  cursorImg = loadImage('./assets/stopCursor.png');
